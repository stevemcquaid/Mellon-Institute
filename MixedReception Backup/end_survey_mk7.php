...
<html>
  ...
  <table width="851" cellpadding="0" bgcolor="white" cellspacing="0" border="1">
	...
	<tr>
		...
		<?php $nextpage = "collect_end_survey_mk7.php"; ?>
	...
	<p><b>[Part 3 - Quick Survey Questions - To help us improve the activity] </b></p>
			...
			<?php 
				...
				$nextpage = "collect_end_survey_mk7.php?feedback=".$feedbackCategory."&ques1=".$question1."&cat=".$cat."&ques2=".$ques2."&cat2=".$cat2."&ques3=".$ques3;
			?>
			</p>
			</noscript>

			<!-- THIS IS OLD LOCATION OF THE FORM: <form name="my_form" action="<?php echo $nextpage;?>" method="post" onsubmit="return validateEndForm()"> -->
			...
			<!--   
				...
				var nextPage = "collect_end_survey_mk7.php?feedback="+ feedBackCategory + "&ques1=" + "&cat=" + cat + "&ques2=" + ques2 + "&cat2=" + cat2 + "&ques3=" + ques3;
			...
			<ul>
				...
				<ol style="list-style-type:none;">
					<li>Teacher's Email Address: <input name="teacher_email" value = "<?php echo $_SESSION['teacher_email']; ?>" size="30"></li>
				</ol>
				...
				<span style="margin-bottom:5px;">To minimize spam engines, please enter the words: </span>
					<?php
          require_once('captcha_lib.php');
          $publickey = "6LfqRMUSAAAAAMsWRl63xNHea0e-lu6KZgCr8qpF"; // you got this from the signup page
          echo recaptcha_get_html($publickey);
          ?>
          <input style="clear:both; margin-top: 10px; margin-left:136px;" type = "submit" value = "Submit">
          </div>
				</div><br> 
			</ul>
    </form>
